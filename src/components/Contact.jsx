	...
	const handleSubmit = (e) => {
		...
		emailjs
			.send(
				...
				{
					from_name: username,
					to_name: "Aisha Jaweria",
					reply_to: user_email,
					to_email: "Aishajaweria1701@gmail.com",
			...
			<div className='text-white contact overflow-x-hidden pt-12 mt-8 ' id='contact'>
				<div className='z-10 w-full sm:w-[650px] m-auto p-8 rounded-2xl' >
					...
					>
						...
						<button
							type='submit'
							className='pt-2 pb-2 px-8 rounded-xl outline-none text-center w-fit font-bold shadow-md bg-gray-900'
						>
