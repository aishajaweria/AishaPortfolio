		...
		<div className='area relative z-0 bg-black w-screen h-screen'>
			...
			<div className='hero relative h-[calc(100vh)] flex justify-center items-center text-white' id='hero'>
				<div className='pt-4 h-36 backdrop-blur-sm rounded-3xl'>
					...
					<p className='mt-3 text-xl'>Passionate Full Stack Web Developer</p>
						<p>Building innovative and scalable web solutions to bring your ideas to life.</p>
						<p>Combining front-end finesse with back-end power to build dynamic web experiences.</p>
				</div>      
			</div>
			<Footer/>
		</div>	
